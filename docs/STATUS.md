...
| Managed models | GGUF discovery/downloads, companion association, load/unload, runner controller | Tests use a fake engine. Real llama-server loading, GPU behavior, and a peer requesting managed inference need end-to-end evidence. |
